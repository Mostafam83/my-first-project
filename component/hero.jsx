...
export default function Hero() {
  ...
  return (
    <div className="hero-slider-container w-full relative bg-gray-100" style={{height: '600px'}}>
      <Swiper
        ...
        navigation={true}
        direction="vertical"  // فقط دسکتاپ عمودی
        ...
        breakpoints={{
          320: { direction: 'horizontal' }, // موبایل افقی
          1024: { direction: 'vertical' },  // دسکتاپ عمودی
        }}
      >
